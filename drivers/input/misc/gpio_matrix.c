...
#if defined(CONFIG_MACH_COOPER) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_TASS) || defined(CONFIG_MACH_GIO)
...
#if 0//defined(CONFIG_MACH_CALLISTO)
// hsil
...
#if !defined(CONFIG_MACH_LUCAS) /*&& !defined(CONFIG_MACH_TASS) */
