...
#define PCAM_FLASH_INFO		        25
#define PCAM_LUX_INFO		        26

#define PCAM_CAM_MODE_CAMERA 0
#define PCAM_CAM_MODE_CAMCORDER 1
#define PCAM_CAM_MODE_FACTORY_TEST 2
...
#define PCAM_AE_LOCK		0
#define PCAM_AE_UNLOCK		1
#define PCAM_AWB_LOCK		2
#define PCAM_AWB_UNLOCK		3
