...
static struct usb_mass_storage_platform_data mass_storage_pdata = {
	.nluns		= 1,
	.vendor		= "SAMSUNG ",
//[LTN_SYSTEM] Dh77.Ji:Changed the name of USB mass storage for COOPER: 2010.12.21
#ifdef CONFIG_SAMSUNG_COOPER_LTN_L
	.product	= "GT-S5830L Card",
#elif  CONFIG_SAMSUNG_COOPER_LTN_B
	.product	= "GT-S5830B Card",
#elif  CONFIG_MACH_COOPER_TELSTRA
...
#ifdef	CONFIG_MACH_COOPER	
#ifdef	CONFIG_MACH_COOPER_TELSTRA
