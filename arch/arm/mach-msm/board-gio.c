...
static struct usb_mass_storage_platform_data mass_storage_pdata = {
	.nluns		= 1,
	.vendor		= "SAMSUNG ",
//[LTN_SYSTEM] Dh77.Ji:Changed the name of USB mass storage for COOPER: 2010.12.21 ( integ from COOPER to GIO )
#ifdef CONFIG_SAMSUNG_GIO_LTN_L
	.product	= "GT-S5660L Card",
#elif  CONFIG_SAMSUNG_GIO_LTN_B
	.product	= "GT-S5660B Card",
#elif  CONFIG_MACH_GIO_TELSTRA
	.product	= "GT-S5660T Card",
#else 
